               ...
               <div className="cta-section">
                  ...
                  {!user && (
                     <p className="cta-hint">
                        Sign up for personalized progress tracking
                     </p>
                  )}
               </div>
            ...
            <section className="benefits-section">
               ...
               <div className="benefits-grid">
                  <div className="benefit-card">
                     ...
                     <p>
                        Monitor your cognitive improvement over time with
                        detailed analytics
                     </p>
                  </div>
                  <div className="benefit-card">
                     ...
                     <h3>Personalized</h3>
                     <p>
                        Games adapt to your level and focus on areas you want to
                        improve
                     </p>
                  </div>
                  <div className="benefit-card">
                     ...
                     <h3>Fun & Engaging</h3>
                     <p>
                        Enjoyable exercises that feel like games, not homework
                     </p>
                  </div>
               </div>
            </section>
