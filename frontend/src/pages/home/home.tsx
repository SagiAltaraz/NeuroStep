         ...
         <div className="main-wrapper">
            <section className="hero-grid">
               <div className="hero-copy">
                  ...
                  <p className="lead">
                     The layout relies on percentages rather than fixed pixels
                     so it scales smoothly from mobile devices up to large
                     desktop displays.
                  </p>
               ...
               <div className="hero-card">
                  ...
                  <p>
                     Percent-based sizing keeps spacing proportional, providing
                     consistent breathing room without extra media queries.
                  </p>
                  <ul>
